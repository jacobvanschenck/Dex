...
contract('Dex', (accounts) => {
    ...
    it('should NOT create limit order if trader token balance is too low', async () => {
        await dex.deposit(
            web3.utils.toWei('99'),
            REP,
            {from: trader1}
    ...
    it('should NOT create limit order if trader DAI balance is too low', async () => {
        await dex.deposit(
            web3.utils.toWei('99'),
            DAI,
            {from: trader1}
    ...
    it('should NOT create Market order if trader token balance is too low', async () => {
        await dex.deposit(
            web3.utils.toWei('99'),
            REP,
            {from: trader1}
